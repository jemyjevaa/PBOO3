...
import { FiUser } from 'react-icons/fi'; // Importa el icono FiUser

const Inicio2 = () => {
    const [isHovered, setIsHovered] = useState(false); // Estado para rastrear si el cursor está sobre el texto o el icono

  // Manejadores de eventos para cuando el cursor entra o sale del texto o el icono
  ...
  return (
    ...
    <div>
      ...
      onMouseEnter={handleMouseEnter} // Cuando el cursor entra en el área del div
      onMouseLeave={handleMouseLeave} // Cuando el cursor sale del área del div
    >
      <FiUser
        style={{ marginRight: '10px', fontSize: '32px', fontWeight: isHovered ? 'bold' : 'normal', transition: 'font-weight 0.3s' }} // Estilo dinámico para el icono con transición
      /> {/* Icono de usuario con tamaño dinámico */}
      <span
        style={{
          fontSize: '20px',
          width: '200px',
          fontWeight: isHovered ? 'bold' : 'normal', // Estilo dinámico para el texto
          transition: 'font-weight 0.3s' // Transición suave
        }}
        onMouseEnter={handleMouseEnter} // Cuando el cursor entra en el área del texto
        onMouseLeave={handleMouseLeave} // Cuando el cursor sale del área del texto
      >
        Jose Rodriguez
      </span> {/* Texto más grande */}
      <Link to="/inicio" style={{ textDecoration: "none" }}>
        <CustomButton>Cerrar sesión</CustomButton> {/* Botón de cerrar sesión */}
      </Link>
    </div>
